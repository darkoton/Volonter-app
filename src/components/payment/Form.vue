      ...
      <div class="mx-auto">
        ...
        <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
            ...
            <div class="mb-6 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  >
                    <svg
                      class="h-4 w-4 text-turquoise-500 dark:text-turquoise-400"
                      aria-hidden="true"
          ...
          <div class="mt-6 grow sm:mt-8 lg:mt-0">
            <div
              class="space-y-4 rounded-lg border border-turquoise-700 bg-turquoise-900 p-6"
            >
              <div class="space-y-2">
              ...
              <dl
                class="flex items-center justify-between gap-4 border-t border-turquoise-700 pt-2"
              >
